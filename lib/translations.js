/**
 * translations.js — Application i18n String Table
 *
 * Central store for all UI text in both English (en) and Thai (th) locales.
 * Access strings via `getTranslation(language, key)` using dot-notation keys.
 *
 * Structure:
 *   translations[locale][section][key] = string
 *
 * Usage:
 *   import { getTranslation } from '@/lib/translations'
 *   getTranslation('en', 'nav.dashboard')  // → 'Dashboard'
 *   getTranslation('th', 'nav.dashboard')  // → 'แดชบอร์ด'
 *
 * Adding new strings:
 *   1. Add the key to the 'en' object first.
 *   2. Add the Thai translation to the 'th' object.
 *   3. Use getTranslation() in the component — never hard-code UI strings.
 *
 * getTranslation returns the English fallback if the key is missing in the
 * requested locale, which prevents blank UI text during partial translations.
 */
...
export const translations = {
  en: {
    ...
    landing: {
      heroTitleLine1: 'Manage Your Expense',
      heroTitleLine2: 'Control your Money',
      heroSubtitle: 'Start creating your budget and save more money.',
    ...
    authPage: {
      ...
      signUpSubtitle: 'Sign up to access your account',
    },
    ...
    density: {
      ...
      auto: 'Auto',
      reset: 'Reset',
      resetTooltip: 'Reset density to default',
      autoModeTooltip: 'Auto mode is currently ',
    },
    ...
    createBudget: {
      ...
      emojiAutoSuggested: 'Auto-suggested — click to change',
      emojiPick: 'Click to pick emoji',
      autoFillFromScan: 'Auto fill from scanned receipt',
      toasts: {
    ...
    editBudget: {
      ...
      requireCategory: 'Please set default category first',
      syncFailed: 'Sync failed',
      syncSuccess: 'Category synced to {count} expense(s)',
    },
    ...
    expensesDetailPage: {
      ...
      stats: {
        ...
        entriesInBudget: 'Entries in this budget',
      },
      deleteDialog: {
        title: 'Are you sure?',
        description: 'This action cannot be undone. This will permanently delete this budget and all related expenses.',
        confirm: 'Continue',
      },
      toasts: {
    ...
    addExpense: {
      ...
      scanHint: 'Scan complete. Select items and click "Add Selected" to add entries.',
      editItemName: 'Edit name',
      editItemAmount: 'Edit amount',
      toasts: {
        scanFailed: 'Receipt scan failed.',
        scanSuccess: 'Receipt scanned successfully.',
        scanFound: 'Scan successful - found {count} items.',
        scanNoItems: 'No line items found from this receipt.',
        ...
        addMultipleSuccess: 'Added {count} scanned item(s).',
  ...
  th: {
    ...
    landing: {
      heroTitleLine1: 'จัดการค่าใช้จ่ายของคุณ',
      heroTitleLine2: 'ควบคุมการเงินของคุณ',
      heroSubtitle: 'เริ่มสร้างงบประมาณและประหยัดเงินให้มากขึ้น',
      getStarted: 'เริ่มต้นใช้งาน',
    },

    authPage: {
      welcomePrefix: 'ยินดีต้อนรับสู่',
      signInSubtitle: 'เข้าสู่ระบบเพื่อใช้งานบัญชีของคุณ',
      signUpSubtitle: 'สมัครสมาชิกเพื่อเริ่มใช้งานบัญชีของคุณ',
    },
    ...
    budgetStats: {
      ...
      totalSpendFormula: 'รวม(ค่าค่าใช้จ่ายทั้งหมด)',
      remaining: 'คงเหลือ',
      availableNow: 'มีอยู่ตอนนี้',
      remainingFormula: 'งบประมาณทั้งหมด - ค่าใช้จ่ายทั้งหมด',
      activeBudgets: 'งบประมาณที่ใช้งาน',
    ...
    density: {
      ...
      auto: 'อัตโนมัติ',
      reset: 'รีเซ็ต',
      resetTooltip: 'รีเซ็ตความหนาแน่นเป็นค่าเริ่มต้น',
      autoModeTooltip: 'โหมดอัตโนมัติปัจจุบันคือ ',
    },
    ...
    createBudget: {
      ...
      emojiAutoSuggested: 'แนะนำอัตโนมัติ — คลิกเพื่อเปลี่ยน',
      emojiPick: 'คลิกเพื่อเลือกอีโมจิ',
      autoFillFromScan: 'เติมอัตโนมัติจากใบเสร็จที่สแกน',
      toasts: {
    ...
    editBudget: {
      ...
      requireCategory: 'โปรดกำหนดหมวดหมู่เริ่มต้นก่อน',
      syncFailed: 'ซิงค์ไม่สำเร็จ',
      syncSuccess: 'ซิงค์หมวดหมู่แล้ว {count} รายการ',
    },
    ...
    expensesPage: {
      ...
      subtitle: 'ค้นหา กรอง และส่งออกค่าค่าใช้จ่ายทั้งหมดได้อย่างรวดเร็ว',
    },
    ...
    expensesStats: {
      ...
      totalAmount: 'ค่าค่าใช้จ่ายทั้งหมด',
      allRecords: 'รายการทั้งหมด',
      totalAmountFormula: 'รวม(จำนวนค่าค่าใช้จ่ายทั้งหมด)',
    ...
    expensesDetailPage: {
      ...
      stats: {
        budgetAmount: 'จำนวนงบประมาณ',
        plannedCapacity: 'งบที่วางแผนไว้',
        totalSpend: 'ใช้จ่ายทั้งหมด',
        currentUsage: 'ยอดใช้งานปัจจุบัน',
        remaining: 'คงเหลือ',
        leftToUse: 'ยอดที่ใช้ได้อีก',
        expenseItems: 'จำนวนรายการค่าใช้จ่าย',
        entriesInBudget: 'รายการในงบประมาณนี้',
      },
      deleteDialog: {
        title: 'ยืนยันการลบใช่ไหม?',
        description: 'การกระทำนี้ไม่สามารถย้อนกลับได้ ระบบจะลบงบประมาณนี้และรายการค่าใช้จ่ายที่เกี่ยวข้องทั้งหมดถาวร',
        confirm: 'ดำเนินการต่อ',
      },
      toasts: {
        deleteSuccess: 'ลบงบประมาณเรียบร้อยแล้ว',
        deleteFailed: 'ไม่สามารถลบงบประมาณได้',
      },
    },
    ...
    addExpense: {
      ...
      clearScan: 'ล้างผลสแกน',
      scanHint: 'สแกนสำเร็จ กรุณาเลือกรายการและกด "เพิ่มรายการที่เลือก" เพื่อเพิ่มข้อมูล',
      editItemName: 'แก้ไขชื่อรายการ',
      editItemAmount: 'แก้ไขจำนวนเงิน',
      toasts: {
        scanFailed: 'สแกนใบเสร็จไม่สำเร็จ',
        scanSuccess: 'สแกนใบเสร็จสำเร็จ',
        scanFound: 'สแกนสำเร็จ พบ {count} รายการ',
        scanNoItems: 'ไม่พบรายการจากใบเสร็จนี้',
        ...
        addMultipleSuccess: 'เพิ่มรายการจากการสแกนแล้ว {count} รายการ',
    ...
    expensesTable: {
      ...
      actions: 'การกระทำ',
      action: 'การกระทำ',
      latestExpenses: 'ค่าใช้จ่ายล่าสุด',
      compact: 'กะทัดรัด',
      comfort: 'สะดวกสบาย',
      auto: 'อัตโนมัติ',
      noExpenses: 'ยังไม่มีข้อมูลค่าใช้จ่าย',
    ...
    reports: {
      ...
      totalAllTime: 'ค่าค่าใช้จ่ายทั้งหมด',
    ...
    admin: {
      ...
      cards: {
        ...
        totalExpenses: 'ค่าค่าใช้จ่ายทั้งหมด',
    ...
    cardInfo: {
      totalBudget: 'งบประมาณทั้งหมด',
      totalSpending: 'ค่าใช้จ่ายทั้งหมด',
      activeBudgets: 'งบประมาณที่ใช้งาน',
    },
 ...
 * Retrieves a i18n string by dot-notation key for the given locale.
 *
 * @param {string} lang - locale code ('en' | 'th')
 * @param {string} key  - dot-notation path, e.g. 'nav.dashboard'
 * @returns {string} The translated string, or the key itself as fallback.
 *
 * Note: Currently only English strings are fully implemented. The `lang`
 * parameter is preserved for future Thai locale expansion — the resolver
 * always reads from `translations.en` for now.
 */
